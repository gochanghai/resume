...
# 工作经历
 ...
 ### 倒序谈下最近做的几个项目：
 ## 顺丰金融-贷后催收系统               2019-7-18 至 至今
 
 > 开发中。。。。
 
 ## 领筑金融云 v1.0                    2019-5-8 至 2019-7-8
 
 > 开发环境的搭建，系统框架的构建及整合，基础功能的实现，授信审批、审核记录、操作日志、开商票功能等的实现
 技术栈：spring boot、spring cloud、mybatis、mysql、redis、vue
 
## 0.易元安全智能信息平台 V1.0          2019-03-15 至 2019-4-19

> 易元安全智能信息平台,该平台的用途是有限空间作业在线监控平台一站式服务解决方案
目前开发的功能主要是有限空间作业流程的监控管理功能
负责web端的业务逻辑实现
技术栈：spring boot 、mybatis、nodejs、vue
 
## 1.微信小程序（深华工程小助手V1.0）    2019-01-01 至 2019-02-28     主要责任：数据交互

> 深华工程小助手的主要业务是给深华建设（深圳）股份有限公司的消防工程项目管理人（如：商务经理/项目经理/安全员/施工员/质检员/资料员/材料员）使用，让工程项目管理人员通过小程序实时查看项目的产值进度，回款进度，施工人员的安全保障情况(如：未参保人员、未进行技术交底人员、未进行安全交底人员)，项目管理人员可以通过小程序随时随地进行产值登记、上传交底，把数据项目数据及时提交给公司领导查看项目的工作情况，查看项目消息及回款消息及商务经理下发的工作任务，
商务经理可以设置项目的申报时间节点、工程节点设置;项目管理人员可以实时查看申报时间节点、工程节点进而有效把握项目的施工进度。系统架构Java段服务器+中间服务器（node） + 小程序
该项目我的主要任务是：实现前端数据和数据服务端交互及数据展示，这要是编写每个页面的js文件的代码编写,及用户账号绑定微信号功能

## 2.工程融资投资服务平台 2018-11-15 至 至今

>自主研发   目标: 给用户创造免费服务

## 3.领筑金服融资服务平台V1.0           2018-10-01 至 2019-01-01     主要责任：项目负责人

> 领筑金服融资服务平台V1.0版本主要是以领筑金服供应链管理（深圳）有限公司现有的工程贷产品所需要业务逻辑进行进行开发；工程贷产品先是要授信通过后才能进行贷款申请，v1.0版本也就是围绕该产品的这两个业务流程进行开发，系统的用户角色有四个（商务经理，工程公司，平台用户，资金方）；首先平台创建工程公司、资金方，然后由资金方创建商务经理。系统的主要功能有：
商务经理：我的项目/我的授信/我的放款/我的认证信息
工程公司：项目管理/授信申请管理/放款申请管理/设置（分公司/企业信息）
平台：客户管理（融资人/工程公司/资金方）/授信申请管理/放款申请管理/金融产品管理/设置
资金方：我的客户/授信批复管理/放宽批复管理/设置
在系统开发的整个过程中，由于部门开发人员少，我被安排成了项目的负责人，我的任务即要做系统架构及系统设计，后端开发，数据库的建立同时还要参与前端开发。
可以说是贯穿整个系统开发过程的始终，参与到系统开发的每一个环节；同时还到领筑金服现场开发及调试有一个礼拜。
系统架构主要是采用前后端分离；系统技术框架主要是使用 Spring-boot， Mybatis（Mybatis-plus），druid, mysql，vue, docker。

## 4.深华消防工程项目管理SAAS系统V1.0   2018-08-01 至 2018-09-30     主要责任：安全及进度模块的开发

> 前期开发的消防工程项目施工智能管理系统交给工程项目使用之后，工程项目管理人员觉得该版本的系统功能太多，使用起开不够简单方便，要求对该系统进改升级简单化；从而为工程事业部的量身定做设计另该系统（深华消防工程项目管理SAAS系统）。该系统主要功能模块有项目管理、进度管理、安全管理、公告消息四个大模块；
开发过程中主要任务是负责进度管理、安全管理模块的 Java后端开发。进度的内容主要是产值登记，产值表上传 ，产值确认，回款登记及统计功能；安全管理的主要是统计参保与未参保人员、交底与未交底人员、教育与未教育人员的实时数据；
系统架构采用：Java端服务器 + 中间服务器(node) + web端。
系统技术框架主要是使用 Spring-boot， Mybatis（Mybatis-plus），druid, mysql，node，vue。

## 5.消防工程项目施工智能管理系统V1.0       2018-04-01 至 2018-07-15     主要责任：系统后台开发

> 研发部门：深化建设（深圳）股份有限公司-工程软件研发部
>系统简介：研发消防工程项目施工智能管理系统的主要目的是解决工程项目上的施工管理困难、施工数据保留不完整的、施工文件保管凌乱等问题，公司及商务经理没能及时理解到工程项目的施工情况；此系统主要目的是解决消防工程项目施工过程中：施工前期消防系统的划分（水/电/风），工地区域划分，合同清单(CAD图纸中数据)导入，成本清单（公司预算部人员提供的数据)导入整理，成本清单量化，工程节点设置，申报时间节点设置；施工过程中的材料采购；材料入库/出库的管理及统计，产值登记及产值文件的上传，回款登记及实时可以查看产值进度及回款进度，项目上的施工人员安全保障情况如：已参保人员，未参保人员，已教育人员/为教育人员等。在开发过程中主要任务就是负责成本清单与合同清单的数据对应关联上；我同时还要建立了一个系统数据关联产生的记忆库，该库的主要功能是用于系统自主学习功能；成本进度模块及安全模块的开发工作；系统技术框架主要使用springboot，Mybatis（Mybatis-plus），druid，springmvc ECharts，
数据库使用mysql;在开发过程中也学到了很多工程行业上的知识，

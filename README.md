...
## 5.建筑工程项目施工智能管理系统V1.0       2018-04-01 至 2018-07-15     主要责任：系统后台开发

> 主要负责开发数据自动匹配关联(成本清单关联合同清单)块(使用算法实现，自己编写算法，调试以及测试)，工程数据的量化模块，数据标准库、数据关联记忆库模块，成本进度，材料成本进度，施工材料出库，安全模块等的开发。
